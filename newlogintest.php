...
<div data-role="page">
	<div data-role="header">
		<a href="logintest.php" data-role="button" data-inline="true">Back</a>
		<h1>New Account</h1>
	</div><!-- /header -->
...
<form action="submit2test.php" method="post" id="newlogin">						
...
<a href="logintest.php" data-role="button" data-mini="true">Already have an Account? Sign in here. </a>
