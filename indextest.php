...
<!-- create button -->
	...
	<div data-role="navbar">
		<ul>
			<li><a href="takephoto1.php" rel = "external"><img src = "delete_icon.jpg" width = "30"/></a></li>
		...
		if (!$row)
		{
			...
			echo "<div data-role= 'popup' id='$ditem'><input type = 'image' img width='280' style='max-width:95%;border:6px double #545565;' class='pretty' src= '".$row["image"]."' /><p> Are You SURE you want to delete the photo? </p><a href ='indextest.php' data-inline = 'true'  data-icon='back' data-role = 'button' >Cancel</a><a data-role = 'button' data-inline = 'true' data-icon = 'delete' data-theme = 'b' class = 'delete' id = '".$row["image"]."' >Delete</a></div>";
			echo "<div class = 'space'></div>";
			++$a;
        }
		}
