...
<body>    
  ...
  <div data-role="header">
	...
	<input type="button" class = "Skip" value ="Skip" inline = "true" onclick="window.location='photopreview.php'" <?php if (!file_exists('upload/'.$_SESSION['id'].'.image2.jpg')) echo 'disabled="disabled"' ?> /> 
        ...
        <div class="container">
            ...
            <div class="upload_form_cont">
                <form id="upload_form" enctype="multipart/form-data" method="post" action="upload2.php">
                    <div>
